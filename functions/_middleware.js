...
export async function onRequest(context) {
  ...
  const dynamic = url.pathname.startsWith('/api/welfare') || url.pathname.startsWith('/welfare/services/') || url.pathname === '/welfare-sitemap.xml';
